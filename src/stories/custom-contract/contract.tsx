...
import store from '../../frontend/redux/main';
import { CustomContractComponent } from '../../frontend/components/contracts/custom_contract/custom_contract';
import TestWrapper from '../../frontend/tests/utils/tests_wrapper';
import { newContract } from '../../frontend/tests/backend/data_samples';
import { CContract } from '../../declarations/backend/backend.did';
import { createCContract } from '../../frontend/components/contracts/custom_contract/utls';
