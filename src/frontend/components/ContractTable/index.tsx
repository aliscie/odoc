...
import CustomDataGrid from "../MuiComponents/DataGrid";
import useParser from "./FormulaParser/useParser";
import RenameColumn from "./ColumnMenu/RenameColumn";
import ChangeColumnPermissions from "./ColumnMenu/ColumnPermision";
import ChangeColumnFormula from "./ColumnMenu/ColumnFormula";
...
export function CustomContractComponent({contract}: { contract: CustomContract }) {
    // const {profile, wallet} = useSelector((state: any) => state.chatsState);
