...
const ProfileRatings: React.FC<ProfileRatingsProps> = ({ profile_history, profileData }) => (
    <Box style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: 16, marginTop: 16 }}>
