...
const GlassCard = styled('div')({
  background: 'linear-gradient(135deg, rgba(76, 29, 149, 0.1), rgba(49, 46, 129, 0.2))',
  backdropFilter: 'blur(10px)',
  ...
  '&:hover': {
    ...
    background: 'linear-gradient(135deg, rgba(91, 33, 182, 0.2), rgba(55, 48, 163, 0.3))',
    '&::before': {
        ...
        <MainCard>
          <CardContent sx={{ p: 4 }}>
            <Box sx={{ textAlign: 'center', mb: 6 }}>
              ...
              <GradientHeading>
                Join ODoc's Exclusive Launch
              </GradientHeading>

              <Box sx={{ color: '#E9D5FF', fontSize: '1.25rem', maxWidth: '36rem', margin: '0 auto' }}>
            ...
            <Box sx={{
              ...
              {features.map((feature, index) => (
                <GlassCard key={index}>
                  ...
                  <div>
                    <Box sx={{ color: '#F3E8FF', fontSize: '1.25rem', fontWeight: 600, mb: 1 }}>
                      {feature.title}
                    </Box>
                    <Box sx={{ color: '#E9D5FF' }}>
                      {feature.description}
            ...
            <Box sx={{ textAlign: 'center' }}>
              <GlassCard sx={{ mb: 3, display: 'block' }}>
                <Box sx={{ color: '#F3E8FF', fontSize: '1.125rem', fontWeight: 600, mb: 2 }}>
                ...
                <Box component="ol" sx={{
                  ...
                  <li>Your lifetime premium access will be automatically activated</li>
                </Box>
              </GlassCard>
              ...
              <FloatingText sx={{ mt: 3, color: '#A78BFA', fontSize: '0.875rem' }}>
                <Sparkles size={16} />
